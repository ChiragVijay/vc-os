  ...
  return (
    <div className="min-h-screen bg-white text-vc-primary font-sans selection:bg-vc-border selection:text-vc-primary">
      <div className="mx-auto max-w-5xl px-6 py-20 md:py-24">
        ...
        <header className="mb-16">
          <div className="flex items-center justify-between gap-3 mb-6">
            <div className="flex items-center gap-3">
              <span className="text-[11px] font-mono uppercase tracking-[0.2em] text-vc-primary border border-vc-primary px-2 py-1">
                Due Diligence Report
              </span>
              <span className="text-[11px] font-mono uppercase tracking-[0.2em] text-vc-secondary">
                {formattedDate}
              </span>
            </div>
            ...
            <div className="p-8 border border-vc-border bg-vc-hover/30">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="md:w-1/3">
                  <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-vc-secondary mb-3">
                    Risk vs. Reward Synthesis
                  </p>
                  ...
                  <div className="bg-vc-hover p-8 border border-vc-border">
                    {data.marketAnalysis.tam && (
                      <div className="mb-6 last:mb-0">
                        <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-vc-secondary mb-2">
                          TAM
                        </p>
        ...
        {/* Footer */}
        <footer className="mt-16 pt-10 border-t border-vc-border flex flex-col md:flex-row justify-between gap-6 text-[10px] font-mono uppercase tracking-[0.1em] text-vc-secondary">
